...
const RegisterFormPatient = () => {
  ...
  const handleSubmit = async event => {
    ...
    // Verifique os dados antes de cadastrar
    // if (validateForm()) {
    // Simulação de salvamento com animação
    try {

      // Combine os campos do formulário com os campos de endereço
      const patientData = {
        fullName,
        gender,
        birthdate,
  ...
  const validateForm = () => {
    // Implemente a validação dos campos do formulário aqui
    // Retorne true se todos os campos forem válidos, caso contrário, retorne false
  }
